				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card form-datos">
							...
							<form action="<?=base_url('clientes/agregar')?>" method="post" class="card-body card-block form-datos">
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label for="nombres" class=" form-control-label">Nombre del Cliente <span class="text-danger">*</span></label>
											<input type="text" name="nombres" id="nombres" placeholder="Nombre del Cliente" class="form-control" required>
										</div>
										<div class="form-group">
											<label for="apellidos" class=" form-control-label">Apellidos del Cliente <span class="text-danger">*</span></label>
											<input type="text" name="apellidos" id="apellidos" placeholder="Apellidos del Cliente" class="form-control" required>
										</div>
										<div class="form-group">
											<label for="ci" class=" form-control-label">Nro de Cédula <span class="text-danger">*</span></label>
											<input type="text" name="ci" id="ci" placeholder="Nro de Cédula" class="form-control" data-url-verifica="<?=base_url('clientes/verifica_ci')?>" autocomplete="off" required>
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="nombre_comercial" id="nombre_comercial" placeholder="Nombre Comercial" class="form-control">
										</div>
										<div class="form-group">
											<label for="nombre_fiscal" class=" form-control-label">Nombre Fiscal </label>
											<input type="text" name="nombre_fiscal" id="nombre_fiscal" placeholder="Nombre Fiscal" class="form-control" >
										</div>
										<div class="form-group">
											<label for="codigo_postal" class=" form-control-label">Código Postal</label>
											<input type="text" name="codigo_postal" id="codigo_postal" placeholder="Código Postal" class="form-control" >
										</div>
										<div class="form-group">
