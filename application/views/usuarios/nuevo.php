				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card form-datos">
							...
							<form action="<?=base_url('usuarios/agregar')?>" method="post" class="card-body card-block form-datos">
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<input type="text" name="ci" id="ci" placeholder="Cedula de identidad" class="form-control" >
										</div>
										<div class="form-group">
											<label for="referencias" class="form-control-label">Referencias </label>
											<textarea name="referencias" id="referencias" rows="5" placeholder="Referencias" class="form-control"></textarea>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label for="direccion" class=" form-control-label">Domicilio </label>
											<input type="text" name="direccion" id="direccion" placeholder="Domicilio" class="form-control" >
										</div>
										<div class="form-group">
