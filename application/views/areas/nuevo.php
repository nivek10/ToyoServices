				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card form-datos">
							...
							<form action="<?=base_url('areas/agregar')?>" method="post" class="card-body card-block form-datos">
								<div class="form-group">
									<label for="area" class=" form-control-label">Área <span class="text-danger">*</span></label>
									<input type="text" name="area" id="area" placeholder="Nombre de Área" class="form-control" required>
								</div>
								<div class="form-group">
									<label for="descripcion" class="form-control-label">Descripción </label>
									<textarea name="descripcion" id="descripcion" rows="7" placeholder="Descripción de Área" class="form-control"></textarea>
								</div>
								<div class="form-group">
