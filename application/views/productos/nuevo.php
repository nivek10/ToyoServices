								...
								<div class="row">
									<div class="col-sm-4">
										...
										<div class="form-group">
											...
											<input type="text" name="cod_ticket" id="cod_ticket" placeholder="Código de Ticket" class="form-control" >
										</div>
										<div class="form-group">
											<label for="marca" class="form-control-label">Marca <span class="text-danger">*</span></label>
											<input type="text" name="marca" id="marca" placeholder="Marca del Producto" class="form-control" required>
										</div>
										<div class="form-group">
											<label for="tipo" class="form-control-label">Tipo </label>
											<input type="text" name="tipo" id="tipo" placeholder="Tipo de Producto" class="form-control">
										</div>
										<div class="form-group">
											<label for="familia" class="form-control-label">Familia </label>
											<input type="text" name="familia" id="familia" placeholder="Familia del Producto" class="form-control" >
										</div>
										<div class="form-group">
											<label for="procedencia" class="form-control-label">Procedencia </label>
											<input type="text" name="procedencia" id="procedencia" placeholder="Procendecia del Producto" class="form-control">
										</div>
										<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="form-group">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 285px; height: 235px; border: 1px solid #CCC;"></div>
												<div>
													<span class="btn btn-secondary btn-file">
														<span class="fileinput-new">Seleccionar Imagen</span>
														<span class="fileinput-exists">Cambiar</span>
														<input type="file" name="imagen" value="" data-url-upload="<?=base_url('productos/upload_imagen')?>">
														<input type="hidden" name="imagen_producto" value="">
													</span>
										...
										<div class="form-group">
											...
											<textarea name="descripcion_breve" id="descripcion_breve" rows="3" placeholder="Descripción Breve" class="form-control"></textarea>
										</div>
										<div class="form-group">
											<label for="descripcion_extensa" class="form-control-label">Descripción Extensa </label>
											<textarea name="descripcion_extensa" id="descripcion_extensa" rows="5" placeholder="Descripción Extensa" class="form-control"></textarea>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<label for="tipo_vehiculo" class="form-control-label">Tipo de Vehículo </label>
											<input type="text" name="tipo_vehiculo" id="tipo_vehiculo" placeholder="Tipo de Vehículo" class="form-control" >
										</div>
										<div class="form-group">
											<label for="marca_vehiculo" class="form-control-label">Marca de Vehículo </label>
											<input type="text" name="marca_vehiculo" id="marca_vehiculo" placeholder="Marca de Vehículo" class="form-control" >
										</div>
										<div class="form-group">
											<label for="modelo_vehiculo" class="form-control-label">Modelo del Vehículo </label>
											<input type="text" name="modelo_vehiculo" id="modelo_vehiculo" placeholder="Modelo del Vehículo" class="form-control" >
										</div>
										<div class="form-group">
											<label for="motor_vehiculo" class="form-control-label">Motor del Vehículo </label>
											<input type="text" name="motor_vehiculo" id="motor_vehiculo" placeholder="Motor del Vehículo" class="form-control">
										</div>
										<div class="form-group">
											<label for="color_vehiculo" class="form-control-label">Color del Vehículo </label>
											<input type="text" name="color_vehiculo" id="color_vehiculo" placeholder="Color del Vehículo" class="form-control" >
										</div>
										<div class="form-group">
...
<script type="text/javascript">
	$(function(){
		$('input[name="imagen"]').on('change', function(){
			...
			var url_upload = $(this).data('url-upload');
			$.ajax({
				url: url_upload,
				type: 'post',
				data: img,
				...
				success: function(resp){
					...
					if (resp.foto != 'error') {
						$('input[name="imagen_producto"]').val(resp.foto);
					} else {
						$('input[name="imagen_producto"]').val('');
					}
				},
